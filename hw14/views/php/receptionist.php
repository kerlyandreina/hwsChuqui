...
<head>
    ...
    <title>Recepcionista - Fábula Dental</title>
        ...
        <div class="container-fluid px-4">
            ...
            <div class="d-flex align-items-center gap-3">
                <div class="text-white d-none d-md-block text-end">
                    ...
                    <span class="fw-bold fs-6">Recepcionista</span>
                </div>
                <div class="dropdown">
                    <a href="#" class="d-block link-light text-decoration-none dropdown-toggle"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="https://ui-avatars.com/api/?name=Recepcionista&background=ffffff&color=0d6efd&bold=true"
                            alt="Usuario Recepcionista" 
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-5 py-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-3 mb-4 border-bottom">
                    <header>
                        <h1 class="h2 fw-bold text-dark mb-0">Panel del Recepcionista</h1>
                        <p class="text-muted mb-0">Resumen general y control de ingresos de la clínica.</p>
                    </header>
                        ...
                        <article class="dashboard-tile bg-white rounded-4 shadow-sm h-100 position-relative overflow-hidden border-0">
                            ...
                            <div class="p-4 position-relative z-1 d-flex flex-column h-100">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <span class="badge bg-success-subtle text-success rounded-pill px-3 py-2 fw-semibold">Finanzas</span>
                                </div>
                                <h4 class="fw-bold mb-1 text-dark">Pagos</h4>
                                <p class="text-muted small mb-4">Control de caja, cobros a pacientes y facturación.</p>

                                <div class="d-flex gap-2 mt-auto">
                                    <a href="../html/payment-form.html"
                                        class="btn btn-success flex-grow-1 rounded-pill fw-semibold text-white">
                                        <i class="bi bi-plus-lg me-1"></i> Cobrar
                                    </a>
