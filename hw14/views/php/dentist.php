...
if (!isset($_SESSION['user']) || !isset($_SESSION['role']) || $_SESSION['role'] !== 'dentist') {
...
<head>
    ...
    <title>Dentista - Fábula Dental</title>
        ...
        <div class="container-fluid px-4">
            ...
            <div class="d-flex align-items-center gap-3">
                <div class="text-white d-none d-md-block text-end">
                    ...
                    <span class="fw-bold fs-6">Dentista</span>
                </div>
                <div class="dropdown">
                    <a href="#" class="d-block link-light text-decoration-none dropdown-toggle"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="https://ui-avatars.com/api/?name=Dentista&background=ffffff&color=0d6efd&bold=true"
                            alt="Usuario Dentista" 
        ...
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-white sidebar collapse shadow-sm">
                <div class="position-sticky pt-4 sidebar-sticky">
                    ...
                    <ul class="nav flex-column gap-1 px-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link rounded-3" href="../php/patient-list.php">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-5 py-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-3 mb-4 border-bottom">
                    <header>
                        <h1 class="h2 fw-bold text-dark mb-0">Panel del Dentista</h1>
                        <p class="text-muted mb-0">Gestión de registros médicos y pacientes.</p>
                    </header>
                </div>
                        ...
                        <article class="dashboard-tile bg-white rounded-4 shadow-sm h-100 position-relative overflow-hidden border-0">
                            ...
                            <div class="p-4 position-relative z-1 d-flex flex-column h-100">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <span class="badge bg-primary-subtle text-primary rounded-pill px-3 py-2 fw-semibold">Módulo Clínico</span>
                                </div>
                                <h4 class="fw-bold mb-1 text-dark">Pacientes</h4>
                                <p class="text-muted small mb-4">Registro de datos personales de pacientes e historiales médicos.</p>

                                <div class="d-flex gap-2 mt-auto">
                                    <a href="../html/patient-form.html"
                                        class="btn btn-primary flex-grow-1 rounded-pill fw-semibold">
