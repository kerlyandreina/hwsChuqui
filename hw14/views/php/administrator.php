...
<head>
    ...
    <title>Administrator - Fábula Dental</title>
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="dropdown">
                    <a href="#" class="d-block link-light text-decoration-none dropdown-toggle"
                        ...
                        <img src="https://ui-avatars.com/api/?name=Administrator&background=ffffff&color=0d6efd&bold=true"
                            alt="Administrator User" 
        ...
        <div class="row">
                    ...
                    <ul class="nav flex-column gap-1 px-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link rounded-3" href="../php/supply-list.php">
                                <i class="bi bi-box-seam-fill me-2"></i> General Inventory
                            </a>
                        </li>
                    </ul>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-5 py-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-3 mb-4 border-bottom">
                    <header>
                        <h1 class="h2 fw-bold text-dark mb-0">Administrator Dashboard</h1>
                        <p class="text-muted mb-0">General overview and clinical inventory management.</p>
                    </header>
                        ...
                        <article class="dashboard-tile bg-white rounded-4 shadow-sm h-100 position-relative overflow-hidden border-0">
                            ...
                            <div class="p-4 position-relative z-1 d-flex flex-column h-100">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <span class="badge bg-warning-subtle text-warning-emphasis rounded-pill px-3 py-2 fw-semibold">Storage</span>
                                </div>
                                <h4 class="fw-bold mb-1 text-dark">Supplies</h4>
                                <p class="text-muted small mb-4">Detailed inventory of materials and stock alerts.</p>
